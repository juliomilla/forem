module Forem
  class TopicsController < Forem::ApplicationController
    ...
    def show
      if find_topic
        ...
        if !params[pagination_param]
          last_page = (@topic.posts.size / Forem.per_page).to_i
    ...
    def create
      ...
      if topic_params[:poll_attributes] && !topic_params[:poll_attributes][:question].nil? && !topic_params[:poll_attributes][:question].empty?
        @topic.poll = Forem::Poll.new
